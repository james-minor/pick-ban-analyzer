...
public class Player {
	...
	public int getMapPointValue(int index)
	{
		...
		// OLD: Old calculation
		// return (int) (_winPercentage * _killDeathRatio * (Math.sqrt(_matchCount)) * (eloRating * eloRating / 1650.0));
		return (int) ((_winPercentage * _killDeathRatio + Math.sqrt(_matchCount)) * (eloRating / 1650.0));
	}
